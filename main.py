...
voice_sleft = mixer.Sound('Voice/stopleft.wav')
voice_sright = mixer.Sound('Voice/stopright.wav')
...
LOWER_LIPS =[61,
 146, 91, 181, 84, 17, 314, 405, 321, 375, 291, 308, 324, 318, 402, 317, 14, 87, 178, 88, 95]
    ...
    while True:
        ...
        if results.multi_face_landmarks:
           ...
           # Starting Voice Indicator 
            if eye_position=="RIGHT" and pygame.mixer.get_busy()==0 and counter_right<2:
                # starting counter 
                counter_right+=1
                # resetting counters 
                counter_center=0
            ...
            if eye_position=="CENTER" and pygame.mixer.get_busy()==0 and counter_center <2:
                # starting Counter 
                counter_center +=1
                # resetting counters 
                counter_right=0
            ...
            if eye_position=="LEFT" and pygame.mixer.get_busy()==0 and counter_left<2: 
                counter_left +=1
                # resetting counters 
                counter_center=0
                counter_right=0
